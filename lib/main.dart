...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<List<String>> privacyPolicy = [
    [
      'tApp',
      '1. 개인정보 처리방침이란?',
      '카이롭터 (이하 “개발자”)는 이용자의 동의를 기반으로 개인정보를 수집, 이용 및 제공하고 있으며,'
          ...
          '본 개인정보 처리방침은 개발자가 제공하는 앱에 적용됩니다. 제공하는 앱은 다음과 같습니다.',
    ],
    [
      't',
      '2. 개인정보 수집',
      '서비스 제공 및 신규 서비스 개발을 위해 개인정보를 수집할 수 있습니다. 현재는 수집하는 항목이 없습니다.',
    ],
    [
      '',
      '개인정보 수집 방법',
